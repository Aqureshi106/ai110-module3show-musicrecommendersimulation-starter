...
The screenshots below show recommendation results in the terminal for the default pop/happy profile.
It includes:
- Song title
- Final match score
- Reasons generated by the scoring function

![Terminal Recommendations Output (Top Portion)](docs/Screenshot%202026-04-08%20181656.png)

![Terminal Recommendations Output (Full List)](docs/Screenshot%202026-04-08%20190737.png)
